...
{
    public partial class AddJsonColumnsToSystemSettings : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RssConfigs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedHtmlTags = table.Column<string>(type: "TEXT", nullable: false),
                    MaxFileSize = table.Column<long>(type: "INTEGER", nullable: false),
                    MaxFilesPerAdvertisement = table.Column<int>(type: "INTEGER", nullable: false),
                    MaxMediaPerAdvertisement = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdvertisementAttributes_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdvertisementAttributes_Dictionaries_DictionaryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RssConfigId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RssItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RssItem_RssConfigs_RssConfigId",
                        column: x => x.RssConfigId,
                        principalTable: "RssConfigs",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsletterCriteria", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NewsletterCriteria_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<string>(type: "TEXT", nullable: false),
                    DictionaryValueId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttributeValues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AttributeValues_AdvertisementAttributes_AttributeId",
                        column: x => x.AttributeId,
                        principalTable: "AdvertisementAttributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttributeValues_Advertisements_AdvertisementId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ModerationReports_Advertisements_AdvertisementId",
                        column: x => x.AdvertisementId,
                        principalTable: "Advertisements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModerationReports_Users_ReportedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementAttributes_CategoryId",
                table: "AdvertisementAttributes",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementAttributes_DictionaryId",
                table: "AdvertisementAttributes",
                column: "DictionaryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeValues_AdvertisementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModerationReports_AdvertisementId",
                table: "ModerationReports",
                column: "AdvertisementId");

            migrationBuilder.CreateIndex(
                name: "IX_ModerationReports_ReportedByUserId",
                table: "ModerationReports",
                column: "ReportedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_NewsletterCriteria_UserId",
                table: "NewsletterCriteria",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RssItem_RssConfigId",
                table: "RssItem",
                column: "RssConfigId");
        }
